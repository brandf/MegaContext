...
**MegaContext [[Multi-headed Focus|multi-head focus]] architectures** — already being considered:
...
1. **[[reference/papers/DNC.md|Differentiable Neural Computer.md]]** (Graves et al., 2016)
...
2. **[[reference/papers/Perceiver - 2103.03206v2.md|Perceiver.md]]** (Jaegle et al., 2021)
...
3. **[[reference/papers/Perceiver IO - 2107.14795v3.md|Perceiver IO.md]]** (Jaegle et al., 2021)
...
4. **[[reference/papers/Slot Attention - 2006.15055v2.md|Slot Attention.md]]** (Locatello et al., 2020)
...
9. **[[reference/papers/Compressive Transformer.md|Compressive Transformers.md]]** (Rae et al., 2019)
...
10. **[[reference/papers/Memorizing Transformers.md|Memorizing Transformers.md]]** (Wu et al., 2022)
...
### Related Papers
- [[reference/papers/DNC.md|Differentiable Neural Computer.md]] — Direct successor to NTM
- [[reference/papers/Perceiver - 2103.03206v2.md|Perceiver.md]] — Cross-attention inspiration for LensNet
- [[reference/papers/Perceiver IO - 2107.14795v3.md|Perceiver IO.md]] — Dual cross-attention architecture
- [[reference/papers/Slot Attention - 2006.15055v2.md|Slot Attention.md]] — Iterative attention refinement
