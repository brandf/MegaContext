...
- Offers a **token-importance perspective** complementary to our learned [[Glossary#Gist / Gist Embedding|gists]];
...
- Distillation methodology aligns with [[GistNet Training]] and [[LensNet Training]]
    ...
    training labels that indicate which spans should remain in [[Glossary#LOD0 / LOD1 / LOD2 (Level of Detail / LOD)|LOD0]] vs compress to
    [[Glossary#LOD0 / LOD1 / LOD2 (Level of Detail / LOD)|LOD1]] or [[Glossary#LOD0 / LOD1 / LOD2 (Level of Detail / LOD)|LOD2]].
...
- Explore **hybrid compression modes** where [[Glossary#LOD0 / LOD1 / LOD2 (Level of Detail / LOD)|LOD1]]/[[Glossary#LOD0 / LOD1 / LOD2 (Level of Detail / LOD)|LOD2]] [[Glossary#Gist / Gist Embedding|gists]] encode
    compressed semantics while LLMLingua-style masks select which [[Glossary#LOD0 / LOD1 / LOD2 (Level of Detail / LOD)|LOD0]] tokens must
...
- Distillation relies on **proprietary teacher models** (GPT-4); reproducing internally
    requires substitute teachers ([[Glossary#Frozen Base Model|base model]] as teacher, domain
...
- LLMLingua-2 is purely **extractive** (selects tokens to keep); cannot synthesize
    ...
    ratios while preserving [[Glossary#Substitutability|substitutability]].
...
- What's the optimal **caching strategy for compression decisions** across sessions—store
    ...
    [[Glossary#Gist / Gist Embedding|gists]] in [[Storage Format]], or recompute dynamically based on [[Working Context]]
