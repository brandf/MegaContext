...
- Highlights the benefit of **explicit retrieval** alongside learned [[Glossary#Gist / Gist Embedding|gists]]; we
...
- Provides baselines for **knowledge-intensive evaluation**, relevant when
  measuring MegaContext's impact on fact-heavy queries using [[Glossary#ΔNLL / ΔNLL@H (Perplexity Delta at Hidden Layer)|ΔNLL@H]] metrics.
...
## What We Can Use
- Adopt **dual-encoder style scoring** within [[LensNet]] to rank candidate [[Glossary#Gist / Gist Embedding|gist]]
...
- Dense retrieval relies on **external corpora updates**; MegaContext must keep
  its [[Glossary#Gist / Gist Embedding|gist]] store fresh and searchable to maintain accuracy (see [[MegaCuration]]
...
- Joint training may be **resource-intensive**; we may start with frozen [[Glossary#Base Model|base model]]
  ...
  end-to-end [[MegaContext End-to-End Training]].
...
- How to balance **learned [[Glossary#Gist / Gist Embedding|gists]] vs explicit retrieval**—should [[LensNet]] prefer
...
- Can we **reuse RAG's index tooling** (FAISS neighbors, ANN search) to explore
  ...
  potentially enabling semantic retrieval across [[Glossary#LOD0 / LOD1 / LOD2 (Level of Detail / LOD)|LOD levels]]?
