...
- Provides a blueprint for [[LensNet]]'s decision head: treat [[Glossary#Expand|expansion]]
  ...
  [[POC Implementation]]), retrieving which [[Glossary#Gist / Gist Embedding|gist]] blocks to expand in the next
  decode step.
...
- Adopt query-based cross-attention in [[LensNet Training]]: latent states aggregate
  [[Glossary#Gist / Gist Embedding|gist]] metadata, then output queries (e.g., "which spans need focus?") attend to
...
- What [[Telemetry|telemetry]] should track **query effectiveness** so we know when
  to refine the [[Focus Allocator]]'s query patterns during [[MegaContext End-to-End Training]]?
...
- [[reference/papers/Perceiver - 2103.03206v2.md|Perceiver]] — Original Perceiver architecture
