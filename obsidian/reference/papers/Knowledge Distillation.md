...
- [[Glossary#Frozen Base Model|Base model]] is frozen → gist quality ceiling set by base model's original training
...
Current [[Glossary#ΔNLL / ΔNLL@H (Perplexity Delta at Hidden Layer)|ΔNLL@H]] uses fixed horizon H. Could we distill at multiple horizons simultaneously?
...
- [[MegaContext End-to-End Training]] - Coordinating GistNet+LensNet distillation

### Metrics & Evaluation
- [[Glossary#ΔNLL / ΔNLL@H (Perplexity Delta at Hidden Layer)|ΔNLL@H]] - Our primary distillation metric
- [[Telemetry]] - Tracking temperature schedules and convergence
- [[POC Implementation]] - Concrete training parameters

### Related Papers
- [[reference/papers/Gist Tokens - 2304.08467v3.md|Gist Tokens]] - Attention-masked compression (complementary to distillation)
- [[reference/papers/LLMLingua-2 - 2403.12968v2.md|LLMLingua-2]] - Token importance via teacher distillation
- [[LoRA]] - Parameter-efficient fine-tuning (potential student architecture)

### Future Work
- [[Future Plan#Track B]] - Domain-adaptive specialists
- [[MegaContext End-to-End Training]] - Joint distillation schedules replacing the legacy alternating loop
- [[MegaContext PRD Index]] - Defines where distillation techniques land within the current roadmap
