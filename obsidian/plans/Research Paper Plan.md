...
- Task 2.7: Explore [[Multi-headed Focus]]—multi-headed working contexts and staging contexts—as optional ablations, instrumenting ΔNLL vs. wall-clock comparisons against single-window baselines.
