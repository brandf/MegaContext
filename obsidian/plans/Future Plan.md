...
- **B.5 [[Positional Encoding#Gaussian RoPE stack|Gaussian RoPE & Global Position Learning]]**
  - Train base models with the Gaussian positional scheme outlined in [[Positional Encoding#Gaussian RoPE stack]] so LOD-aware uncertainty is native rather than adapter driven.
