...
tags:
  - plans
  - prd
summary: Training and evaluation roadmap for the Cognitive-Core MegaContext language model that externalizes knowledge into composable MegaContexts.
---
...
The **[[Cognitive Core]] [[MegaContext]] Large Language Model (C²MC-LLM)** extends the [[MegaContext]] framework to train a model that **relies on a persistent, composable set of MegaContexts** rather than memorizing facts in its weights.
...
- **Position encoding:** [[Positional Encoding#Gaussian RoPE stack|Gaussian RoPE]] + ALiBi blend to stabilize across MCs.
