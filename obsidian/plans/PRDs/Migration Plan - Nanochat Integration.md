...
- Identify hook points for MegaContext subsystems:
  ...
  - Memory/model boundaries needed by the [[Cognitive-Core MegaContext]] PRD.
...
- **E2E Training:** Embed the [[1. MegaContext End-to-End Training]] loop into nanochat’s trainer, including horizon ΔNLL evaluation and gist losses.
- **MegaPrediction:** Attach the multi-LOD decoding head defined in [[2. MegaPrediction Training]]; expose CLI flags for gist-first inference.
- **Cognitive Core:** Scaffold composite memory management and CK reliance checks per [[3. Cognitive-Core MegaContext]].
