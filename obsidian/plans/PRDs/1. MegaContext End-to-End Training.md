...
This document describes the **end-to-end training procedure** for [[MegaContext]], integrating [[GistNet]], [[LensNet]], and the base LLM into a unified training loop. It includes the horizon evaluation details, KV-cache guidance, and **gist-level auxiliary losses** at multiple levels of detail (LOD0/LOD1/LOD2).
