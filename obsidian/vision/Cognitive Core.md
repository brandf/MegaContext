...
---
> Implementation POR: [[Cognitive-Core Training]]. Use this page for conceptual background only.
...
2. **Perform e2e C2 training**: See: [[Cognitive-Core Training#5. Training Loop]]
