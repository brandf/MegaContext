...
- **Linkages:** informed the legacy POC deliverables; retain for historical context while [[MegaContext PRD Index]] defines the active requirements alongside [[POC Architecture]] assumptions.
...
These constraints tied directly to the original POC milestones; treat them as historical guardrails while the active requirements come from [[MegaContext PRD Index]] and inform the performance envelope summarized in [[Performance Sketch]].
