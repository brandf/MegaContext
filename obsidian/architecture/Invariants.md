...
This document defines the fundamental invariants that must hold throughout MegaContext's operation. These constraints ensure correctness, predictability, and maintain the [[Glossary#Substitutability|substitutability]] property that allows [[Glossary#Gist / Gist Embedding|gists]] to replace tokens seamlessly.
...
- [[Glossary#LOD0 / LOD1 / LOD2 (Level of Detail / LOD)|LOD1]] and [[Glossary#LOD0 / LOD1 / LOD2 (Level of Detail / LOD)|LOD2]] [[Glossary#Gist / Gist Embedding|gists]] cost 1 token each
...
**Enforcement:**
- [[Focus Allocator]] checks budget before every [[Glossary#Expand|expand]] operation
- Every [[Glossary#Expand|expand]] must be balanced by corresponding [[Glossary#Collapse|collapses]]
...
- [[Glossary#Expand|Expand]]/[[Glossary#Collapse|collapse]] operations preserve temporal adjacency
...
- [[Glossary#LOD0 / LOD1 / LOD2 (Level of Detail / LOD)|LOD1]] [[Glossary#Gist / Gist Embedding|gists]] represent exactly 32 tokens (one LOD0 block)
- [[Glossary#LOD0 / LOD1 / LOD2 (Level of Detail / LOD)|LOD2]] [[Glossary#Gist / Gist Embedding|gists]] represent exactly 1,024 tokens (32 LOD0 blocks)

**Why it matters:**
- Matches [[GistNet]] compression granularity (32→1)
- Enables clean [[Glossary#Expand|expand]]/[[Glossary#Collapse|collapse]] operations without partial blocks
- Simplifies [[MegaContext Tree]] storage (deterministic offsets)
- Ensures [[Glossary#Gist / Gist Embedding|gists]] always represent complete, meaningful units

**Enforcement:**
- [[MegaContext Tree]] ingests tokens in 32-token batches
- [[Focus Allocator]] only swaps complete blocks
- [[GistNet]] only generates [[Glossary#Gist / Gist Embedding|gists]] for full 32-token spans
...
- Cannot have an LOD1 [[Glossary#Gist / Gist Embedding|gist]] representing 64 tokens or an LOD2 [[Glossary#Gist / Gist Embedding|gist]] representing 512 tokens

**Why it matters:**
- Ensures [[Glossary#Gist / Gist Embedding|gists]] accurately represent their source spans
- Maintains the hierarchical 32-ary tree structure
- Allows [[Focus Allocator]] to predict the effect of [[Glossary#Expand|expand]]/[[Glossary#Collapse|collapse]] operations
- Simplifies [[MegaContext Tree]] navigation

**Enforcement:**
- [[GistNet]] only produces [[Glossary#Gist / Gist Embedding|gists]] from 32-child spans
- [[MegaContext Tree]] stores [[Glossary#Gist / Gist Embedding|gists]] at fixed levels corresponding to span size
...
**What it means:**
- [[Glossary#Gist / Gist Embedding|Gists]] are positioned at the **central token index** of their span for [[Glossary#RoPE (Rotary Position Embedding)|RoPE]]
- [[Glossary#LOD0 / LOD1 / LOD2 (Level of Detail / LOD)|LOD0 tokens]] use their actual sequential positions
- This ensures [[Glossary#RoPE (Rotary Position Embedding)|RoPE]] phase information remains consistent when swapping [[Glossary#LOD0 / LOD1 / LOD2 (Level of Detail / LOD)|LODs]]
...
- Using central position for [[Glossary#Gist / Gist Embedding|gists]] minimizes phase error
- Preserves the base model's ability to attend correctly across different [[Glossary#LOD0 / LOD1 / LOD2 (Level of Detail / LOD)|LODs]]

**Enforcement:**
- [[Working Context]] assembly applies [[Glossary#RoPE (Rotary Position Embedding)|RoPE]] position IDs during materialization
- [[Glossary#Gist / Gist Embedding|Gists]] inherit the central position of their span from the [[MegaContext Tree]]
...
- Minimizes maximum distance from [[Glossary#Gist / Gist Embedding|gist]] to any token it represents
...
- Cannot have an [[Glossary#LOD0 / LOD1 / LOD2 (Level of Detail / LOD)|LOD1]] [[Glossary#Gist / Gist Embedding|gist]] that wasn't generated by [[GistNet]]
- [[Glossary#Expand|Expand]] operations require children to exist in the tree
- [[Glossary#Collapse|Collapse]] operations require parent [[Glossary#Gist / Gist Embedding|gist]] to exist in the tree
...
**Definition:**
When [[Glossary#Expand|expanding]] or [[Glossary#Collapse|collapsing]], all 32 children/parent must be swapped atomically.

**Implications:**
- Cannot [[Glossary#Expand|expand]] half of an [[Glossary#LOD0 / LOD1 / LOD2 (Level of Detail / LOD)|LOD1]] [[Glossary#Gist / Gist Embedding|gist]] (e.g., only 16 of its 32 tokens)
- Cannot [[Glossary#Collapse|collapse]] just 10 of 32 [[Glossary#LOD0 / LOD1 / LOD2 (Level of Detail / LOD)|LOD0 blocks]] into an incomplete [[Glossary#LOD0 / LOD1 / LOD2 (Level of Detail / LOD)|LOD1]] [[Glossary#Gist / Gist Embedding|gist]]
...
- `test_level_consistency()` - Ensures [[Glossary#LOD0 / LOD1 / LOD2 (Level of Detail / LOD)|LODs]] match span sizes
...
3. **Block Alignment Invariant** → Clean [[Glossary#LOD0 / LOD1 / LOD2 (Level of Detail / LOD)|LOD]] swaps
...
By maintaining these invariants, MegaContext ensures that [[Glossary#Gist / Gist Embedding|gists]] can seamlessly [[Glossary#Substitutability|substitute]] for tokens without breaking the [[Glossary#Frozen Base Model|frozen base model]]'s expectations.
