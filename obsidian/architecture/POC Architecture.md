...
| [[MegaContext Tree]] | `src/megacontext/memory/tree.py` | Maintain contiguous-in-time hierarchy (LOD0/LOD1/LOD2) in RAM (future stream to disk) | Input: gists/tokens; Output: node handles, metadata |
