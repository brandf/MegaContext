...
---
The [[Focus Allocator]] transforms [[LensNet]] utilities into concrete expand/collapse actions. This document compares the **greedy strategy** used in the current [[POC Scope|POC]] against future **learned policies** and explores trade-offs between approaches.
...
- Maximum [[Glossary#LOD0 / LOD1 / LOD2 (Level of Detail / LOD)|LOD]] blocks (root level) cannot collapse
