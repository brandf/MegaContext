...
All [[Working Context]] entries must cover exactly one full block at a single [[Glossary#LOD0 / LOD1 / LOD2 (Level of Detail / LOD)|LOD]].
...
1. **Neural Turing Machines** (Graves et al., 2014) — [[reference/papers/Neural Turing Machines.md|Analysis]] — Content-based addressing and memory controllers
2. **Differentiable Neural Computer** (Graves et al., 2016) — [[reference/papers/DNC.md|Analysis]] — Learned memory allocation and routing
3. **Slot Attention** (Locatello et al., 2020) — [[reference/papers/Slot Attention - 2006.15055v2.md|Analysis]] — Object-centric iterative attention mechanism
