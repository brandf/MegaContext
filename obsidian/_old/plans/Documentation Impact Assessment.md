...
- Legacy POC plan (archived) — superseded by the PRD stack; mark legacy phases (Lightning notebooks, staged focus experiments) as archival or rewrite as historical context.
- [[POC Implementation]] — rewrite to describe nanochat-oriented modules, referencing [[MegaContext End-to-End Training]], [[MegaPrediction Training]], and [[Cognitive-Core Training]] as the new milestones.
- Legacy “Alternating Optimization” note — scrub references and point everything at [[MegaContext End-to-End Training]] instead.
...
- [[PRD Progress Tracker]] (checkpoints, open questions) to keep the PRDs living documents.
