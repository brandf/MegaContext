...
| --- | --- | --- |
| Single rented GPU (32 GB+) | `bash run10.sh --gpu 5090 [--mc] [--block_size 8|32|128] [--gistnet_type transformer|mean --gistnet_layers 2|4 --gistnet_pooling mean|query|cls --gistnet_head linear|mlp] [--lensnet_layers 2|4|8 --lensnet_head linear|mlp] [--allocator simple|...]` | Depth 12, ~3.1 B tokens, fits 5090/A6000 class cards. |
...
3. **Monitor**:
   ...
   - WANDB dashboard for ΔNLL@H, swap rate, residency, MFU.
